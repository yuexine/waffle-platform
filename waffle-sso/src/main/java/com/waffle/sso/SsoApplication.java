...
import com.waffle.component.hbase.config.HBaseAutoConfiguration;
...
@Import(value = {KafkaConfiguration.class, HBaseProperties.class, HBaseAutoConfiguration.class})
